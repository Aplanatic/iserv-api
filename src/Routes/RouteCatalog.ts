...
export const ROUTES = [
  ...
  },
  {
    ...
    module: "calendar",
    method: "GET",
    path: "/iserv/calendar/feed/plugin",
    ...
    parameters: [
      ...
      p("start", "query", true, "Range start"),
      p("end", "query", true, "Range end"),
    ],
    provenance: upstream("src/Calendar/CalendarService.ts"),
    compatibility: "A visible plugin identifier returned HTTP 404 during the live contract check.",
  },
  {
    id: "files.overview",
    module: "files",
